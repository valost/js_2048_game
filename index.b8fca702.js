...
function manageMessages() {
    if (game.getStatus() === (0, _gameClassJsDefault.default).STATUS.win) messageWin.classList.remove("hidden");
    else if (game.getStatus() === (0, _gameClassJsDefault.default).STATUS.lose) messageLose.classList.remove("hidden");
}
manageGameField();
manageGameScore();
manageMessages();
...
class Game {
    ...
    checkGameStatus() {
        ...
        if (!canMove && !hasEmptyCells) this.status = Game.STATUS.lose;
    }
    moveLeft() {
